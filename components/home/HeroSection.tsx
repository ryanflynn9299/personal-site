        ...
        <section className="py-24 text-center md:py-32">
            <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <p className="mx-auto mt-6 max-w-3xl text-lg text-slate-300 md:text-xl">
                    Welcome to my corner of the web. I'm a software engineer specializing in backend development,
                    passionate about creating performant, accessible, and maximally usable applications.
                </p>
