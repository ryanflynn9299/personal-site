        ...
        >
            ...
            <div className="relative z-10 flex h-full flex-col">
                ...
                <div className="flex flex-1 flex-col p-6">
                    ...
                    <h3 className={`font-heading font-semibold text-slate-50 ${isFeatured ? 'text-2xl mt-2' : 'text-lg mt-1'}`}>
                        {post.title}
                    </h3>
                    <p className={`mt-3 text-slate-300 ${isFeatured ? 'flex-grow' : 'text-sm'}`}>
                        {post.summary}
                    </p>
