        ...
        <div style={scaleStyle} className={className}>
          ...
          ></span>
                    {papers.map((item, i) => {
                        ...
                        const itemWithCorrectIndex = React.isValidElement(item) && item.props && typeof item.props === 'object' && item.props !== null && 'index' in item.props
                            ? React.cloneElement(item as React.ReactElement<any>, { index: i })
                            : item;
