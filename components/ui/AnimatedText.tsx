...
export function AnimatedText({ text, animationType = 'stagger-words', className }: AnimatedTextProps) {
    ...
    if (animationType === 'decode') {
        ...
        return (
            <motion.h1 initial="hidden" animate="visible" variants={container} className={className}>
