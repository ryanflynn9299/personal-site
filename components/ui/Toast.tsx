...
const baseClasses = "relative w-full overflow-hidden rounded-lg border p-4 shadow-lg backdrop-blur-md";
const typeClasses = {
    ...
    return (
        ...
        >
            <div className="flex items-start gap-4">
                ...
                <button onClick={() => onDismiss(id)} className="flex-shrink-0 text-slate-400 hover:text-white">
                    <X className="h-5 w-5" />
                </button>
            </div>
        </motion.div>
