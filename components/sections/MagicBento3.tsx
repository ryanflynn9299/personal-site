...
export function BentoGrid() {
  ...
  const dialogTitleId = selectedCard
    ? `bento-dialog-${selectedCard.category
        .toLowerCase()
        .replace(/\s+/g, "-")}`
    : undefined;
  ...
  return (
    <div className="relative flex items-center justify-center my-16">
      ...
      <motion.div className="grid grid-cols-1 sm:grid-cols-[repeat(3,minmax(200px,1fr))] md:grid-cols-[repeat(4,minmax(200px,1fr))] auto-rows-[12rem] gap-4 w-full max-w-5xl">
          ...
          >
            ...
            >
              ...
              >
                <h2
                  id={dialogTitleId}
                  className="font-heading text-3xl font-bold text-sky-300"
                >
