        ...
        <div className={className}>
          <ReactMarkdown
            ...
            components={{
              ...
              h1: ({ node, ...props }) => (
                <h1 className="font-heading text-4xl font-bold mt-8 mb-4 text-slate-50" {...props} />
              ),
              h2: ({ node, ...props }) => (
                <h2 className="font-heading text-3xl font-bold mt-6 mb-3 text-slate-50" {...props} />
              ),
              h3: ({ node, ...props }) => (
                <h3 className="font-heading text-2xl font-bold mt-4 mb-2 text-slate-50" {...props} />
              ),
              h4: ({ node, ...props }) => (
                <h4 className="font-heading text-xl font-bold mt-4 mb-2 text-slate-50" {...props} />
              ),
              p: ({ node, ...props }) => (
